...
# Khởi tạo danh sách BOOKS (cần có để test)
BOOKS = [
    {"id": 1, "title": "Clean Code", "author": "R. Martin", "price": 10.99},
    {"id": 2, "title": "Clean Architecture", "author": "R. Martin", "price": 15.99},
    {"id": 3, "title": "The Great Gatsby", "author": "F. Scott Fitzgerald", "price": 19.99}
]
...
def list_books():
    ...
    links = {
        "self": {"href": u(page)},
        "first": {"href": u(1)},
        "last": {"href": u(max(last, 1))} # Đã sửa lỗi thiếu dấu ngoặc ở đây
    }   
    if page > 1: 
